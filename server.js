...
async function broadcastPriceUpdates() {
    ...
    const symbols = [ 'BTCUSDT', 'ETHUSDT', 'ADAUSDT', 'DOTUSDT', 'MATICUSDT', 
    'SOLUSDT', 'AVAXUSDT', 'ATOMUSDT', 'LINKUSDT', 'XRPUSDT',
    'DOGEUSDT', 'LTCUSDT', 'BCHUSDT', 'ETCUSDT', 'XLMUSDT',
    'TRXUSDT', 'EOSUSDT', 'XTZUSDT', 'ALGOUSDT', 'FILUSDT'];
